...
import com.example.robin.news30.Data.News
import com.example.robin.news30.Data.NewsApi
...
//    }
     ...
     fun fetchRepos(){
        _loading.value = true
        newscall = NewsApi.instance?.getNews("top-headlines?sources=$source&apiKey=4663b6001744472eaac1f5aa16076a7a");
